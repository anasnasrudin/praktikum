    ...
    <main class="d-flex vh-100 w-100">
        <div id="sidebar" class="px-3 mb-3">
            <div id="sidebar-header" class="d-flex align-items-center text-white gap-2">
                ...
                <span class="fs-5">PT. THICKKOSHEWAD</span>
            </div>
            <div id="sidebar-menu" class="d-flex flex-column gap-2">
                <a href="/"
                    class="d-flex px-3 py-2 align-items-center text-decoration-none text-white rounded-3 {{ request()->is('/') ? 'active' : '' }}">
                    <i class="fa-solid fa-house"></i>
                    <span class="ms-2">Dashboard</span>
                </a>
                <a href="/absensi"
                    class="d-flex px-3 py-2 align-items-center text-decoration-none text-white rounded-3 {{ request()->is('absensi*') ? 'active' : '' }}">
                    <i class="fa-solid fa-list"></i>
                    <span class="ms-2">Absensi</span>
                </a>
                <a href="/gaji"
                    class="d-flex px-3 py-2 align-items-center text-decoration-none text-white rounded-3 {{ request()->is('gaji*') ? 'active' : '' }}">
                    <i class="fa-solid fa-book-bookmark"></i>
                    <span class="ms-2">Gaji</span>
                </a>
                <a href="/karyawan"
                    class="d-flex px-3 py-2 align-items-center text-decoration-none text-white rounded-3 {{ request()->is('karyawan*') ? 'active' : '' }}">
                    <i class="fa-solid fa-user"></i>
                    <span class="ms-2">Karyawan</span>
                </a>
                <a href="/jabatan"
                    class="d-flex px-3 py-2 align-items-center text-decoration-none text-white rounded-3 {{ request()->is('jabatan*') ? 'active' : '' }}">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="/"><i class="fa-solid fa-home"></i>Home</a></li>
